...
<div id="actionContainer">
    <nav class="navbar navbar-expand-lg navbar-dark app-navbar justify-content-between">
        <a class="navbar-brand" href="home.html"><i class="fas fa-taxi"></i> PICKUP</a>
                                ...
                                <div class="tab-pane fade show active text-center" id="nav-book" role="tabpanel"
                                    ...
                                    <div class="vehicle-select-container" style="display: none;">
                                        ...
                                        <div class="row justify-content-md-center text-center">
                                            <div class="col-md-4">
                                                <form class="book-ride-form" role="form" action="samlsso" method="post"  autocomplete="off">
                                                    <!--input type="submit" id="btn-book" class="btn btn-primary mt-5 pickup-btn book-btn text-center continue" value="CONFIRM"-->
    ...
    <footer class="text-muted footer text-center">
        <span>Copyright ©  <a href="http://wso2.com/" target="_blank">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn default-btn" data-dismiss="modal">OK</button>
                </div>
            </div>
        </div>
    </div>
