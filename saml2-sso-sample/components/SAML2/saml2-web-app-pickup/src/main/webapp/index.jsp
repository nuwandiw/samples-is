        ...
        <div class="row">
            <div class="col-sm-9 col-md-4 col-lg-4 mx-auto login-sec">
                ...
                <form class="app-login-form" role="form" action="samlsso" method="post"  autocomplete="off">
                    <!--a href="home.html" class="btn btn-primary btn-login pickup-btn">LOGIN</a-->
                    <input type="submit" id="btn-login" class="btn btn-primary btn-login pickup-btn" value="LOGIN">
                </form>
            </div>
        </div>
    </div>
